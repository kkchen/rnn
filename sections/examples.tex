    ...
    \begin{columns}
        \begin{column}{0.61\textwidth}
            \begin{itemize}
                ...
                \end{itemize}
                \item My code: \blueurl{https://goo.gl/xomjs8}
            \end{itemize}
        \end{column}
...
\begin{frame}{%
    ...
    \begin{columns}
        \begin{column}{0.63\textwidth}
            ...
            \visible<.->{\includegraphics[width=\textwidth]{handwriting}}
        \end{column}
...
\begin{frame}{Very short list of RNN applications (2/2)}
    ...
    \end{itemize}
    \visible<.->{\includegraphics[width=\textwidth]{video_prediction}}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \vspace{2mm}
            \visible<2->{\includegraphics[width=\textwidth]{bigbang}}
        \end{column}
    \end{columns}
\end{frame}
