...
\begin{frame}{Output-to-state connections}
    \begin{columns}
        \begin{column}{0.71\textwidth}
            ...
            \input{figures/output_state_folded}
        \end{column}
        \begin{column}{0.29\textwidth}
            \begin{itemize}
...
\begin{frame}{Teacher forcing}
    \begin{columns}
        \begin{column}{0.71\textwidth}
            ...
            \input{figures/teacher_forcing_folded}
        \end{column}
        \begin{column}{0.29\textwidth}
            \begin{itemize}
...
\begin{frame}{Odds \& ends}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Use truncated backpropagation through time
