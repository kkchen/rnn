...
\begin{frame}{Bidirectionality}
    \begin{columns}
        ...
        \begin{column}{0.47\textwidth}
            ...
            \end{itemize}
            \uncover<+->{Bidirectional RNN: \textcolor{blue}{forward}- and \textcolor{Green4}{reverse}-directional RNNs with separate states, outputs, weights, biases}
            \begin{itemize}[<.->]
...
\begin{frame}{Other deep RNNs: deep state-to-state connections \citep{PascanuICLR14}}
